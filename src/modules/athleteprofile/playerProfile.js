...
const matches = [
  {
    ...
    journey: 5,
    date: `${7}/${10}/${2020}`,
    time: `${7}/${11}/${2020},${14}:${11}`,
    estimateEndTime: `${7}/${11}/${2020},${16}:${50}`,
    stadium: 'Estadio X',
    price: 'Q25.00',
    parking: 'Sí, gratis',
    transmissions: [
  ...
  },
  {
    ...
    date: `${7}/${11}/${2020}`,
    time: `${7}/${11}/${2020},${14}:${11}`,
    estimateEndTime: `${7}/${11}/${2020},${16}:00`,
    stadium: 'Estadio X',
    price: 'Q25.00',
    parking: 'Sí, gratis',
    transmissions: [
...
const player = {
  ...
  biography: `Fabián Esteban Vizcaíno Chinchilla nació en el año 1995 es un beisbolista guatemalteco,
